  ...
  return (
    <Suspense>
      <VerifyAttributesStepView
        deliver={[{ label: "Send by email", href: "/verification/verify-credentials/email/schemas/cred-defs/attributes/verification-email", icon: "mail" }]}
        back="/verification/verify-credentials/email/schemas/cred-defs"
