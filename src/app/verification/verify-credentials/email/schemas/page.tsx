  ...
  return (
    <Suspense>
      <VerifySchemaStepView
        next="/verification/verify-credentials/email/schemas/cred-defs"
        crumbs={[{ label: "Verification", href: "/verification" }, { label: "Request proof", href: "/verification/verify-credentials" }, { label: "Email" }]}
      />
    </Suspense>
  );
}
