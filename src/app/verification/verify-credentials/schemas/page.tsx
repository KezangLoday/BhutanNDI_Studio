  ...
  return (
    <Suspense>
      <VerifySchemaStepView
        next="/verification/verify-credentials/schemas/cred-defs"
        crumbs={[{ label: "Verification", href: "/verification" }, { label: "Request proof", href: "/verification/verify-credentials" }, { label: "Connection" }]}
      />
    </Suspense>
  );
}
