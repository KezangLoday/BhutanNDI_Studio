  ...
  return (
    <Suspense>
      <VerifyAttributesStepView
        deliver={[
          { label: "Send by QR code", href: "/verification/verify-credentials/schema/attributes/verification-qr", icon: "verify" },
          { label: "Send by email", href: "/verification/verify-credentials/schema/attributes/verification-email", icon: "mail" },
        ]}
